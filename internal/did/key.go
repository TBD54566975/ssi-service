...
func (h *keyDIDHandler) CreateDID(request service.CreateDIDRequest) (*service.CreateDIDResponse, error) {
	// create the DID
	...
	return &service.CreateDIDResponse{
		DID:        storedDID.DID,
		PrivateKey: storedDID.PrivateKeyBase58,
	}, nil
}

func (h *keyDIDHandler) GetDID(id string) (*service.GetDIDResponse, error) {
