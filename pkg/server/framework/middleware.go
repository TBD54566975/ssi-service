...
import "github.com/tbd54566975/vc-service/pkg/server"
...
type Middleware func(handler server.Handler) server.Handler
...
func WrapMiddleware(mw []Middleware, handler server.Handler) server.Handler {
