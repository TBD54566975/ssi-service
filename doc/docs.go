    ...
    "paths": {
        ...
        "/v1/dids/{method}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "boolean",
                        "description": "When true, returns soft-deleted DIDs. Otherwise, returns DIDs that have not been soft-deleted. Default is false.",
                        "name": "deleted",
                        "in": "query"
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github.com_tbd54566975_ssi-service_pkg_server_router.GetDIDsRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github.com_tbd54566975_ssi-service_pkg_server_router.CreateIssuanceTemplateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/manifests/applications": {
            ...
            "put": {
                ...
                "responses": {
                    "201": {
                        "description": "Operation with a SubmitApplicationResponse type in the ` + "`" + `result.response` + "`" + ` field.",
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github.com_tbd54566975_ssi-service_pkg_server_router.GetWebhooksResponse"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github.com_tbd54566975_ssi-service_pkg_server_router.CreateWebhookRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/github.com_tbd54566975_ssi-service_pkg_server_router.CreateWebhookResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/webhook.GetSupportedNounsResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/webhook.GetSupportedVerbsResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github.com_tbd54566975_ssi-service_pkg_server_router.GetWebhookResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
    ...
    "definitions": {
        ...
        "credential.VerifiablePresentation": {
            ...
            "properties": {
                ...
                "verifiableCredential": {
                    "description": "Verifiable credential could be our object model, a JWT, or any other valid credential representation",
                    "type": "array",
                    "items": {}
                }
            }
        ...
        "did.Document": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "As per https://www.w3.org/TR/did-core/#did-subject intermediate representations of DID Documents do not\nrequire an ID property. The provided test vectors demonstrate IRs. As such, the property is optional.",
                    "type": "string"
                },
                "keyAgreement": {
                    "type": "array",
        ...
        "exchange.Constraints": {
            ...
            "properties": {
                ...
                "limit_disclosure": {
                    "description": "If a predicate property is present, filter must be too\nhttps://identity.foundation/presentation-exchange/#predicate-feature",
                    "type": "string"
                },
                "same_subject": {
                    "type": "array",
        ...
        "exchange.InputDescriptor": {
            ...
            "properties": {
                ...
                "group": {
                    "description": "Must match a grouping strings listed in the ` + "`" + `from` + "`" + ` values of a submission requirement rule",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "framework.Status": {
            ...
            "properties": {
                "message": {
                    "description": "When ` + "`" + `status` + "`" + ` is ` + "`" + `not_ready` + "`" + `, then message contains explanation of why it's not ready.",
                    "type": "string"
                },
                "status": {
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.CreateCredentialRequest": {
            ...
            "properties": {
                ...
                "data": {
                    "description": "Claims about the subject. The keys should be predicates (e.g. \"alumniOf\"), and the values can be any object.",
                    "type": "object",
                    "additionalProperties": {
                        "type": "string"
                    },
                ...
                "revocable": {
                    "description": "Whether this credential can be revoked. When true, the created VC will have the \"credentialStatus\"\nproperty set.",
                    "type": "boolean"
                },
                "schemaId": {
                    "description": "A schema ID is optional. If present, we'll attempt to look it up and validate the data against it.",
                    "type": "string"
                },
                "subject": {
                ...
                "suspendable": {
                    "description": "Whether this credential can be suspended. When true, the created VC will have the \"credentialStatus\"\nproperty set.",
                    "type": "boolean"
                }
            }
        },
        "github.com_tbd54566975_ssi-service_pkg_server_router.CreateCredentialResponse": {
            ...
            "properties": {
                ...
                "credentialJwt": {
                    "description": "The same verifiable credential, but using the syntax defined for the media type ` + "`" + `application/vc+jwt` + "`" + `. See\nhttps://w3c.github.io/vc-jwt/ for more details.",
                    "type": "string"
                }
            }
        },
        "github.com_tbd54566975_ssi-service_pkg_server_router.CreateDIDByMethodRequest": {
            ...
            "properties": {
                "keyType": {
                    "description": "Identifies the cryptographic algorithm family to use when generating this key.\nOne of the following: \"Ed25519\", \"X25519\", \"secp256k1\", \"P-224\",\"P-256\",\"P-384\", \"P-521\", \"RSA\"",
                    "type": "string"
                },
                "options": {
                    "description": "Options for creating the DID. Implementation dependent on the method."
                }
            }
        },
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.CreateIssuanceTemplateRequest": {
            ...
            "properties": {
                "credentialManifest": {
                    "description": "ID of the credential manifest that this template corresponds to.",
                    "type": "string"
                },
                "credentials": {
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.CreatePresentationDefinitionRequest": {
            ...
            "properties": {
                "author": {
                    "description": "DID of the author of this presentation definition. The DID must have been previously created with the DID API,\nor the PrivateKey must have been added independently.",
                    "type": "string"
                },
                "authorKid": {
                    "description": "The privateKey associated with the KID will be used to sign an envelope that contains\nthe created presentation definition.",
                    "type": "string"
                },
                "format": {
                    "$ref": "#/definitions/exchange.ClaimFormat"
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.CreateSchemaRequest": {
            ...
            "properties": {
                ...
                "authorKid": {
                    "description": "AuthorKID represents the KID of the author's private key to sign the schema. Required if sign is true.",
                    "type": "string"
                },
                "name": {
                    "type": "string"
                ...
                "sign": {
                    "description": "Sign represents whether the schema should be signed by the author. Default is false.\nIf sign is true, the schema will be signed by the author's private key with the specified KID",
                    "type": "boolean"
                }
            }
        },
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.CreateWebhookRequest": {
            "type": "object",
            "required": [
                "noun",
                "url",
            ...
            "properties": {
                ...
                "url": {
                    "description": "The URL to post the output of this request to Noun.Verb action to.",
                    "type": "string"
                },
                "verb": {
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.CreateWebhookResponse": {
            "type": "object",
            "properties": {
                "webhook": {
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.GetDIDsRequest": {
            "type": "object",
            "properties": {
                "filter": {
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.GetReadinessResponse": {
            "type": "object",
            "properties": {
                "serviceStatuses": {
                    "description": "A map from the name of the service ot the status of that current service.",
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/framework.Status"
                    }
                },
                "status": {
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.GetSubmissionResponse": {
            ...
            "properties": {
                ...
                "verifiablePresentation": {
                    "description": "The verifiable presentation containing the presentation_submission along with the credentials presented.",
                    "$ref": "#/definitions/credential.VerifiablePresentation"
                }
            }
        },
        "github.com_tbd54566975_ssi-service_pkg_server_router.GetWebhookResponse": {
            "type": "object",
            "properties": {
                "webhook": {
                    "$ref": "#/definitions/webhook.Webhook"
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.GetWebhooksResponse": {
            "type": "object",
            "properties": {
                "webhooks": {
                    "type": "array",
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.ListDefinitionsRequest": {
            "type": "object"
        },
        "github.com_tbd54566975_ssi-service_pkg_server_router.ListDefinitionsResponse": {
            "type": "object",
            "properties": {
                "definitions": {
                    "type": "array",
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.OperationResult": {
            ...
            "properties": {
                ...
                "response": {
                    "description": "Populated iff Error == \"\". The type should be specified in the calling APIs documentation."
                }
            }
        },
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.ReviewApplicationRequest": {
            "type": "object",
            "properties": {
                "approved": {
                    "type": "boolean"
                ...
                "credential_overrides": {
                    "description": "Overrides to apply to the credentials that will be created. Keys are the ID that corresponds to an\nOutputDescriptor.ID from the manifest.",
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/model.CredentialOverride"
                    }
                },
                "reason": {
                    "type": "string"
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.StoreKeyRequest": {
            ...
            "properties": {
                "base58PrivateKey": {
                    "description": "Base58 encoding of the bytes that result from marshalling the private key using golang's implementation.",
                    "type": "string"
                },
                "controller": {
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.UpdateCredentialStatusRequest": {
            ...
            "properties": {
                "revoked": {
                    "description": "The new revoked status of this credential. The status will be saved in the encodedList of the StatusList2021\ncredential associated with this VC.",
                    "type": "boolean"
                },
                "suspended": {
                    "type": "boolean"
        ...
        "github.com_tbd54566975_ssi-service_pkg_server_router.VerifyCredentialRequest": {
            ...
            "properties": {
                "credential": {
                    "description": "A credential secured via data integrity. Must have the \"proof\" property set.",
                    "$ref": "#/definitions/credential.VerifiableCredential"
                },
                "credentialJwt": {
                    "description": "A JWT that encodes a credential.",
        ...
        "manifest.Issuer": {
            ...
            "properties": {
                ...
                "styles": {
                    "description": "an object or URI as defined by the DIF Entity Styles specification\nhttps://identity.foundation/wallet-rendering/#entity-styles",
        ...
        "manifest.OutputDescriptor": {
            ...
            "properties": {
                ...
                "display": {
                    "description": "both below: an object or URI as defined by the DIF Entity Styles specification",
        ...
        "rendering.DisplayMappingObject": {
            ...
            "properties": {
                ...
                "path": {
                    "description": "Ifa path is present it must be an array of JSON Path string expressions\nand the schema property must also be present.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "text": {
                    "description": "If path is not present, the text value is required with no other properties",
                    "type": "string"
                }
            }
        },
        ...
        "webhook.GetSupportedNounsResponse": {
            "type": "object",
            "properties": {
                "nouns": {
                    "type": "array",
        ...
        "webhook.GetSupportedVerbsResponse": {
            "type": "object",
            "properties": {
                "verbs": {
                    "type": "array",
