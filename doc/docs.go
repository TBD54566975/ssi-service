    ...
    "definitions": {
        ...
        "github_com_TBD54566975_ssi-sdk_did.Service": {
            ...
            "properties": {
                ...
                "serviceEndpoint": {
                    "description": "A string, map, or set composed of one or more strings and/or maps\nAll string values must be valid URIs"
                },
                "type": {
                    "type": "string"
                }
        ...
        "github_com_tbd54566975_ssi-service_pkg_service_presentation_model.Request": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "ID for this request. It matches the \"jti\" claim in the JWT.\nThis is an output only field.",
                    "type": "string"
                },
                "issuerId": {
                ...
                "presentationRequestJwt": {
                    "description": "PresentationDefinitionJWT is a JWT token with a \"presentation_definition\" claim within it. The\nvalue of the field named \"presentation_definition.id\" matches PresentationDefinitionID.\nThis is an output only field.",
                    "type": "string"
                }
            }
        },
        ...
        "pkg_server_router.CreateRequestRequest": {
            ...
            "properties": {
                ...
                "issuerId": {
                    "description": "DID of the issuer of this presentation definition. The DID must have been previously created with the DID API,\nor the PrivateKey must have been added independently.",
                    "type": "string"
                },
                "issuerKid": {
